                        ...
                        <div class="card border-0 rounded-3 shadow">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" v-model="barcode" @keyup="searchProductByBarcode" placeholder="Scan or Input Barcode">
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text"><i class="fa fa-search"></i></span>
                                    <input type="text" class="form-control" v-model="productName" @keyup="searchProductByName" placeholder="Search by Product Name">
                                </div>
                                <div class="mb-3">
    ...
    export default {
        ...
        setup(props) {
            ...
            const searchProductByName = () => {
                axios.post('/apps/transactions/searchProductByName', {
